...
export function AppNavigation() {
    return (
        <Tab.Navigator screenOptions={({ route }) => ({
            ...
            <Tab.Screen name={screen.restaurant.tab} component={RestaurantStack}
                options={{ title: "Restaurantes" }} />
            <Tab.Screen name={screen.favorites.tab} component={FavoritesStack}
                options={{ title: "Favoritos asd" }} />
